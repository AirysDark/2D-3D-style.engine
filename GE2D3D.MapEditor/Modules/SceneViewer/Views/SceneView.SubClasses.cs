...
namespace GE2D3D.MapEditor.Modules.SceneViewer.Views
{
    public partial class SceneView
    {
        ...
        private class SortingFilteringCollection<T> : ICollection<T>
        {
            ...
            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => ((System.Collections.IEnumerable)_items).GetEnumerator();

            private static readonly Comparison<int> RemoveJournalSortComparison = (x, y) => Comparer<int>.Default.Compare(y, x); // Sort high to low
        ...
        private struct AddJournalEntry<T>
        {
            ...
            public override bool Equals(object obj) => obj is AddJournalEntry<T> entry && Equals(Item, entry.Item);
        }
    }
}
